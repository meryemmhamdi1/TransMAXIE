...
def get_args():
    ...
    parser.add_argument("--data-dir", type=str, help="Path of directory for multilingual Dep parsing ahmad et al. 2019 benchmark")
    ...
    parser.add_argument("--use-eisner", default=False, action='store_true')
    parser.add_argument("--be-verbose", default=False, action='store_true')
    parser.add_argument("--use-word-embed", default=False, action='store_true')

    ## Hyperparameters
    parser.add_argument("--word-emb-dim", type=int, default=100)
    parser.add_argument("--pos-emb-dim", type=int, default=50)
    parser.add_argument("--rnn-size", type=int, default=400)
    parser.add_argument("--rnn-depth", type=int, default=3)
    parser.add_argument("--edge-mlp-size", type=int, default=500)
    parser.add_argument("--rel-mlp-size", type=int, default=100)
    ...
    parser.add_argument("--early-stop-ep", type=int, default=10)
